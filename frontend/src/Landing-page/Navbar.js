                ...
                <div className="row">
                    <div className="col-4">
                        <Link className="navbar-brand" to="/">
                            <img src="media\images\image.png" style={{ width: "40%" }} />
                        </Link>
                    </div>
                    <div className="col-1">
                        ...
                        <div className="collapse navbar-collapse d-flex col-7 " id="navbarSupportedContent">
                            <ul className="navbar-nav navbar_ke_liye text-muted nav-active-blue ms-auto d-flex justify-content-end" style={{fontSize:"14.4px", color:"rgb(128,128,128)"}} >
                                <li className="">
